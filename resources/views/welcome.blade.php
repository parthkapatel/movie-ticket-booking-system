                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        @if(session('roles') == "admin")
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/city/create/">
                                    Manage Cities
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/theater/create/">
                                    Manage Theaters
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/cast/create/">
                                    Manage Casts
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="/theater/assign/create/">
                                        Assign Movies
                                    </a>
